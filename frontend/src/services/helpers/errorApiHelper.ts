...
type ErrorDetails = {
  ...
  const errorTranslations: ErrorTranslations = {
    ...
    Unauthorized: {
        ...
        "No authenticated user found in JWT": "Votre session a expiré. Veuillez vous reconnecter.",
        "Bad credentials": "Les identifiants ne sont pas corrects, veuillez réessayer."
    },
    AccessDenied: {
        "Invalid JWT token": "Erreur d'authentification",
        "Missing JWT token": "Erreur d'authentification",
        "Token expired, please renew it.": "Votre session a expirée, veuillez vous reconnecter." 
    },
    NotFound: {
    ...
    BadRequestDetails: {
      ...
      "This value is too short. It should have 8 characters or more.": "Le mot de passe doit faire 8 caractères minimum.",
